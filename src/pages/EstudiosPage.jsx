        ...
        <div className="container mb-9  shadow-lg">
          <div className="row">
            <div className="col-md-4">
              <div className="card text-center1 ">
                <div className="card-body">
                  <img src="/descarga.png" className="card-img-top" width="50px" />
            ...
            <div className="col-md-4">
              <div className="card text-center1">
                <div className="card-body">
                  <img src="/descarga.png" className="card-img-top" alt="..." />
            ...
            <div className="col-md-4">
              <div className="card text-center1 ">
                <div className="card-body">
                  <img src="/logo-campus-ve.png" className="card-img-top" alt="..." />
